# Task 25: `SiloConnectionManager` -- Full-Mesh Manager With Reconnection and Deduplication
...
- [task-24-silo-connection.md](task-24-silo-connection.md)
...
6. Accept inbound connections from `asyncio.start_server` (driven by [task-26](task-26-tcp-cluster-transport.md)).
