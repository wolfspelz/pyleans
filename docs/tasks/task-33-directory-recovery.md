# Task 33: Directory Crash Recovery -- Rebuild Ownership After Silo Failure

> **Coding rules**: Follow [CLAUDE.md](../CLAUDE.md) strictly -- clean code, SOLID, strict type hints, mandatory tests.\
> **On completion**: Fill in "Summary of implementation" at the bottom with files created, decisions made, deviations, and test coverage.

## Dependencies
- [task-29-failure-detector.md](task-29-failure-detector.md)
...
Each peer responds with its local activations and their `activation_epoch`. Merging by lowest epoch resolves the split-view scenario from [task-31](task-31-distributed-grain-directory.md).
...
The split-view race in [task-31](task-31-distributed-grain-directory.md) can produce two activations of the same grain on different silos during the period when silos disagreed on ownership. Rebuild finds both in the merge step. Resolution:
