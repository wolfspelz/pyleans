# Task 37: Multi-Silo Counter Sample
...
- [task-18-counter-client.md](task-18-counter-client.md)
- [task-34-remote-grain-invoke.md](task-34-remote-grain-invoke.md)
- [task-35-silo-lifecycle-stages.md](task-35-silo-lifecycle-stages.md)
- [task-36-multi-silo-integration-tests.md](task-36-multi-silo-integration-tests.md)
...
The value of this task is **demonstrability**. Integration tests in [task-36](task-36-multi-silo-integration-tests.md) prove correctness; the sample proves that a person using the library can run a cluster without reading source code.
...
- [ ] No tests beyond README-verification needed -- integration tests in [task-36](task-36-multi-silo-integration-tests.md) cover correctness; this task covers demonstrability
